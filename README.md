...
<h2 name="Support">Supported Platforms</h2>
<!--Supported platforms-->
<p align="justify">
OpenNAS if fully compatible with all VHDL versións, has been tested with serveral devices Xilinx and Intel FPGAS, and simulated with ModelSim.
